...
define('SOURCE_DIR', BASE_PATH . '/PACKS_WORKFLOWS_JOBS');
define('TARGET_DIR', BASE_PATH . '/PACKS_WORKFLOWS_JOBS_FR');
define('TEMP_DIR', BASE_PATH . '/PACKS_WORKFLOWS_JOBS_FR/.temp');
