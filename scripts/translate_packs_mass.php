...
define('SOURCE_DIR', BASE_PATH . '/PACKS_WORKFLOWS_VENDEURS');
define('TARGET_DIR', BASE_PATH . '/PACKS_WORKFLOWS_VENDEURS_FR');
define('TEMP_DIR', BASE_PATH . '/PACKS_WORKFLOWS_VENDEURS_FR/.temp');
