  ...
  <div class="content content-boxed">
    <div class="text-center fs-sm push">
      <span class="d-inline-block py-2 px-4 bg-body fw-medium rounded">
        <a class="link-effect" href="be_pages_generic_profile.php">John Doe</a> on July 16, 2024 &bull; <span>5 min</span>
      </span>
    </div>
    ...
    <div class="col-md-4">
      <a class="block block-rounded block-link-pop overflow-hidden" href="javascript:void(0)">
        ...
        <div class="block-content block-content-full fs-sm fw-medium">
          <span class="text-primary"><?php $one->get_name(); ?></span> on July 2, 2024 · <span>12 min</span>
        </div>
      </a>
    </div>
    <div class="col-md-4">
      <a class="block block-rounded block-link-pop overflow-hidden" href="javascript:void(0)">
        ...
        <div class="block-content block-content-full fs-sm fw-medium">
          <span class="text-primary"><?php $one->get_name(); ?></span> on July 6, 2024 · <span>15 min</span>
        </div>
      </a>
    </div>
    <div class="col-md-4">
      <a class="block block-rounded block-link-pop overflow-hidden" href="javascript:void(0)">
        ...
        <div class="block-content block-content-full fs-sm fw-medium">
          <span class="text-primary"><?php $one->get_name(); ?></span> on June 29, 2024 · <span>10 min</span>
        </div>
      </a>
    </div>
    <div class="col-md-4">
      <a class="block block-rounded block-link-pop overflow-hidden" href="javascript:void(0)">
        ...
        <div class="block-content block-content-full fs-sm fw-medium">
          <span class="text-primary"><?php $one->get_name(); ?></span> on June 16, 2024 · <span>13 min</span>
        </div>
      </a>
    </div>
    <div class="col-md-4">
      <a class="block block-rounded block-link-pop overflow-hidden" href="javascript:void(0)">
        ...
        <div class="block-content block-content-full fs-sm fw-medium">
          <span class="text-primary"><?php $one->get_name(); ?></span> on May 23, 2024 · <span>10 min</span>
        </div>
      </a>
    </div>
    <div class="col-md-4">
      <a class="block block-rounded block-link-pop overflow-hidden" href="javascript:void(0)">
        ...
        <div class="block-content block-content-full fs-sm fw-medium">
          <span class="text-primary"><?php $one->get_name(); ?></span> on May 15, 2024 · <span>7 min</span>
        </div>
      </a>
    </div>
  </div>
