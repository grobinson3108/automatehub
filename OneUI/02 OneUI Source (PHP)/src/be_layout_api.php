      ...
      <div class="table-responsive">
        <table class="table table-hover mb-0">
          ...
          <tbody>
            ...
            <tr>
              <td>
                <button type="button" class="btn btn-sm btn-alt-primary mb-3" data-toggle="layout" data-action="dark_mode_system">Dark Mode System</button>
                <p class="fs-sm mb-0 text-muted">
                  Enables Dark Mode based on system preference
                </p>
              </td>
              <td>
                <code>One.layout('dark_mode_system');</code>
              </td>
              <td>
                <code>data-toggle="layout" data-action="dark_mode_system"</code>
              </td>
            </tr>
          </tbody>
        </table>
