    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">November 5, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">November 1, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">October 27, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">October 25, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">October 10, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">October 1, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">September 19, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">September 15, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">September 7, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">August 28, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">August 19, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
        ...
        <div class="block-content block-content-full">
          ...
          <div class="fs-sm text-muted">August 5, 2024</div>
        </div>
      </a>
    </div>
    <!-- END Course -->
