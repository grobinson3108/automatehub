          ...
          <tbody class="fs-sm">
            ...
            ?>"><?php echo $badges[$rand]['text']; ?></span>
                ...
                <td class="d-none d-sm-table-cell">
                  ...
                  <div class="progress mb-1" style="height: 5px;" role="progressbar" aria-valuenow="<?php echo $profit; ?>" aria-valuemin="0" aria-valuemax="100">
                    <div class="progress-bar bg-success" style="width: <?php echo $profit; ?>%;"></div>
                  </div>
...
<!-- Page JS Plugins -->
<?php $one->get_js('js/plugins/chart.js/chart.umd.js'); ?>
