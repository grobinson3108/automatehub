...
<!-- Hero -->
<div id="one-hero" class="bg-body-extra-light">
  <div class="content content-full">
    <div class="row g-0 justify-content-center text-center">
      <div class="col-md-10 pt-7 pb-5">
        <div class="d-inline-flex align-items-center space-x-1 fs-sm badge bg-body text-dark mb-2 p-2">
          <i class="fa fa-fw fa-award text-success"></i>
        ...
        <p class="fs-5 fw-medium text-muted mb-4 mx-xl-8">
          One super flexible UI framework for web developers and founders who value their time. Built with <span class="text-body-color fw-semibold">Bootstrap 5</span>, <span class="text-body-color fw-semibold">no jQuery</span> in core, now with a brand new <a class="fw-semibold" href="javascript:void(0)" data-toggle="layout" data-action="dark_mode_toggle">dark mode</a>.
        </p>
        <a class="btn btn-primary py-2 px-3 m-1" data-toggle="click-ripple" href="be_pages_dashboard.php" target="_blank">
          <i class="fa fa-fw fa-desktop opacity-50 me-1"></i> Live preview
        </a>
        <a class="btn btn-light py-2 px-3 m-1" data-toggle="click-ripple" href="#one-vue-edition">
          <i class="fa fa-fw fa-arrow-down opacity-50 me-1"></i> Learn more
        </a>
      </div>
    </div>
    <div class="pull-b text-center">
      <img class="img-fluid d-dark-none" src="<?php echo $one->assets_folder; ?>/media/various/hero-promo.png" alt="Hero Promo">
      <img class="img-fluid d-none d-dark-block" src="<?php echo $one->assets_folder; ?>/media/various/hero-promo-dark.png" alt="Hero Promo in dark mode">
    </div>
  </div>
</div>
<!-- END Hero -->
      ...
      <div class="order-md-0 col-md-7 d-flex align-items-center">
        <div>
          ...
          <p class="fs-lg fw-medium text-muted mb-4">
            A separately sold Vue.js 3 based version of OneUI is now included in the package for free.
          </p>
          <h3 class="h5 mb-3">Included versions in Vue Edition</h3>
          <ul class="fa-ul space-y-2 text-muted push">
            <li>
              <span class="fa-li text-start">
                <i class="fa fa-check-circle text-success"></i>
              </span>
              Vue.js 3 + Vue Router based on Vite boilerplate
            </li>
            <li>
            <span class="fa-li text-start">
                <i class="fa fa-check-circle text-success"></i>
              </span>
              Laravel 12 + Inertia.js + Vue.js 3. Authentication features also included.
            </li>
          </ul>
          <a class="btn btn-primary py-2 px-3 m-1" data-toggle="click-ripple" href="https://pixelcave.com/products/oneui-vue-edition">
            Check it out
    ...
    <div class="py-5">
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-xl-4 py-3">
          ...
          <h4 class="mb-2">Laravel 12 Starter Kit</h4>
          <p class="text-muted">
    ...
    <div class="py-5">
      ...
      <div class="row items-push">
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
          ...
          <p class="text-muted">
            It is finally here and looks amazing! It was made to work with all color themes and included pages. Choose between light, dark or system preference out of the box.
          </p>
          <!-- END New Features -->
        </div>
        <div class="col-sm-6 col-md-4 col-xl-3">
    ...
    <div class="py-5">
      ...
      <div class="row items-push">
        ...
        <div class="col-md-4">
          ...
          <p class="text-muted mb-2">
            Everything from the design to the code is beautifully crafted and the customer support is great also. Congratulations pixelcave.
          </p>
          <p class="fs-sm fw-medium">
      ...
      <div class="row items-push">
        <div class="col-md-4">
          ...
          <p class="text-muted mb-2">
            One of the most well thought-through and comprehensive templates available. Consistently excellent design and broad feature base. Highly Recommended!
          </p>
          <p class="fs-sm fw-medium">
      ...
      <div class="row items-push">
        <div class="col-md-4">
          ...
          <p class="text-muted mb-2">
            This is one of the best all-around packages I've purchased. Not only is the Documentation is excellent and well-written, but the code itself is intelligently built and a pleasure to work with. Thanks for doing such great work.
          </p>
          <p class="fs-sm fw-medium">
...
<div id="one-call-to-action" class="bg-body-extra-light">
  <div class="content content-full">
    <div class="py-5 py-md-8 text-center">
      <h2 class="h1 fw-black mb-2">
        Crafted with <i class="fa fa-fw fa-heart text-city"></i> by <a class="link-fx" href="https://pixelcave.com">pixelcave</a>
      </h2>
      <p class="fs-lg fw-medium text-muted mb-4">
        Passionate web design and development with over 20,000 customers worldwide.
      </p>
      <a class="btn btn-success py-2 px-3 m-1" data-toggle="click-ripple" href="https://pixelcave.com/products/oneui?purchase=true&ref=demo">
  ...
  <div class="content py-5">
    <div class="row fs-sm fw-medium">
      ...
      <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
        <a class="fw-semibold" href="https://pixelcave.com/products/oneui" target="_blank"><?php echo $one->name . ' ' . $one->version; ?></a> &copy; <span data-toggle="year-copy"></span>
      </div>
    </div>
  </div>
</footer>
