  ...
  <div class="content-header bg-white-5">
    ...
    <div class="d-flex align-items-center gap-1">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end border-0" aria-labelledby="sidebar-dark-mode-dropdown">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu fs-sm smini-hide border-0 text-end" aria-labelledby="sidebar-themes-dropdown">
          ...
          <!-- Sidebar Styles -->
          <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
          <a class="dropdown-item fw-medium d-dark-none" data-toggle="layout" data-action="sidebar_style_light" href="#">
            <span>Sidebar Light</span>
          </a>
          <a class="dropdown-item fw-medium d-dark-none" data-toggle="layout" data-action="sidebar_style_dark" href="#">
          ...
          <!-- Header Styles -->
          <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
          <a class="dropdown-item fw-medium d-dark-none" data-toggle="layout" data-action="header_style_light" href="#">
            <span>Header Light</span>
          </a>
          <a class="dropdown-item fw-medium d-dark-none" data-toggle="layout" data-action="header_style_dark" href="#">
