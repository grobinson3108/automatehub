...
$one                             = new Template('OneUI', '5.11', 'assets');
...
$one->title                      = 'OneUI - Bootstrap 5 Admin Template &amp; UI Framework';
$one->description                = 'OneUI - Bootstrap 5 Admin Template &amp; UI Framework created by pixelcave';
